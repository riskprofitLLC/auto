...
export default function App() {
	...
	return (
		<View style={styles.container}>
			...
			{/* 🚗 Панель управления авто (показывается только при подключении) */}
			{connectedDeviceId && (
				<CarControls
			...
			<FlatList
				...
				ListEmptyComponent={<Text style={styles.empty}>{isScanning ? 'Выполняется сканирование...' : 'Устройства не найдены. Нажмите "Начать поиск".'}</Text>}
			/>
